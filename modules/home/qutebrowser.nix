...
in {
  options.my.qutebrowser = {enable = mkEnableOption "qutebrowser";};
  config = mkIf cfg.enable {
    programs.qutebrowser = {
      enable = true;
      package = pkgs.qutebrowser;
      loadAutoconfig = true; # Change once I've customized to my liking
      searchEngines = {
        DEFAULT = "https://www.google.com/search?hl=en&q={}&udm=14";
