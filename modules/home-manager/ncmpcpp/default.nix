...
in {
    ...
    services.mpd = {
          ...
          extraConfig = ''
            ...
            port "6600"
            music_directory "/home/occam/documents/music"
            playlist_directory "/home/occam/.config/mpd/playlists"
            db_file "/home/occam/.config/mpd/mpd.db"
            log_file "/home/occam/.config/mpd/mpd.log"
            pid_file "/home/occam/.config/mpd/mpd.pid"
            state_file "/home/occam/.config/mpd/mpdstate"
            restore_paused "yes"
            max_playlist_length "4000"
      ...
      programs.ncmpcpp = {
        ...
        bindings = [];
        mpdMusicDir = "/home/occam/documents/music";
        settings = {
          mpd_host = "127.0.0.1";
          mpd_port = "6600";
